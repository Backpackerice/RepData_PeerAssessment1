...
2. Let’s fill in a missing NA with the average number of steps in the same 5-min interval.
...
5. Calculate the mean and median steps with the filled in values:
